...
public class DbMods {
    ...
    public String userRoleType = ""; // getting it from joined user_role table.
        ...
        if (inputData.userPassword.compareTo(inputData.userPassword2) != 0) { // case sensitive comparison
    ...
    public static StringData findByLogIn(DbConn dbc, String user, String pass) {
        ...
        try {
            ...
            if (results.next()) { // id is unique, one or zero records expected in result set
                ...
                sd.errorMsg = "Web User with those credentials not found.";
            }
            results.close();
            stmt.close();
        } catch (Exception e) {
            sd.errorMsg = "Exception thrown in DbMods.findByLogIn(): " + e.getMessage();
        }
        return sd;
